...
my $data = {
  lientje_jun2012 => {
    ...
    sat_long => 'Saturday, June 30th, 2012',
    sun_long => 'Sunday, July 1st, 2012',
    both_long => 'Saturday and Sunday, June 30th and July 1st, 2012',
    party => 1,
    late => 0,
    lunch_offered => 0,
  },
...
<img alt="" border="0" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" width="1" height="1">
		...
		print $fh qq{
    		...
    		if($enable_paypal) {
      			print $fh qq{
				If you did not already pay via PayPal, please send a check for $cost_string to:
				LDF Farms
				32040 NE 112th St
				Carnation, WA 98014
				...
				multiple people with a single check) on the check.
      			...
      			print $fh qq{
				Please bring a check for $cost_string to the clinic.
